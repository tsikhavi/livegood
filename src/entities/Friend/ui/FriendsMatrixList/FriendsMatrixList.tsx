    ...
    <Box className={ cn( classes.wrapper, {}, [ className ] ) }>
      ...
      {depth < 3 && (
        <Box className={cn(classes.nextDept, {
          ...
          <FriendsMatrixList getRefs={getRefs} friend={friend?.left || null} depth={depth + 1}/>
          <FriendsMatrixList  getRefs={getRefs} friend={friend?.right || null} depth={depth + 1}/>
        </Box>
      )}
    </Box>
  );
